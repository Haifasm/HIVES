...
public class MainActivity extends AppCompatActivity {
    ...
    private DatabaseReference PostRef,hivesref;
    Dialog myDialog;
    Dialog imageDialog;
    ...
    private void BrowsePost() {
        ...
        final FirebaseRecyclerAdapter<AllPosts, PostViweHolder> FirebaseRecycleAdapter
            ...
            protected void populateViewHolder(final PostViweHolder postViweHolder, final AllPosts module, final int i) {
                ...
                final ViewGroup.LayoutParams params = postViweHolder.mViwe.getLayoutParams();
                postViweHolder.mViwe.setVisibility(View.GONE);
